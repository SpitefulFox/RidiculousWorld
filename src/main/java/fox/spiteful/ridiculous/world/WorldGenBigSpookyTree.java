...
public class WorldGenBigSpookyTree extends WorldGenAbstractTree
{
    /**
    ...
    public WorldGenBigSpookyTree(boolean notify)
    {
        super(notify);
    }
    ...
    void generateLeafNode(int p_76491_1_, int p_76491_2_, int p_76491_3_)
    {
        ...
        for (int i1 = p_76491_2_ + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.func_150529_a(p_76491_1_, l, p_76491_3_, f, (byte)1, RidiculousBlocks.treeLeaves);
        }
    }
    ...
    void func_150530_a(int[] p_150530_1_, int[] p_150530_2_, Block block)
    {
        ...
        if (aint2[b1] != 0)
        {
            ...
            for (int j = aint2[b1] + b4; i != j; i += b4)
            {
                ...
                if(block == RidiculousBlocks.treeLogs && rand.nextInt(12) == 0)
                    this.setBlockAndNotifyAdequately(this.worldObj, aint3[0], aint3[1], aint3[2], RidiculousBlocks.spookyLog, rand.nextInt(4));
                else
    ...
    void generateTrunk()
    {
        ...
        this.func_150530_a(aint, aint1, RidiculousBlocks.treeLogs);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.func_150530_a(aint, aint2, RidiculousBlocks.treeLogs);
            }
        }
    }
