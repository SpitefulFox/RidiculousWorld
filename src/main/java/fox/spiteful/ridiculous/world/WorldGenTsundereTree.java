...
public class WorldGenTsundereTree extends WorldGenAbstractTree
{
    /**
    ...
    public WorldGenTsundereTree(boolean notify)
    {
        super(notify);
    }
        ...
        for (aint1[p_150529_5_] = aint[p_150529_5_]; i1 <= l; ++i1)
        {
            ...
            while (j1 <= l)
            {
                ...
                else
                {
                    ...
                    {
                        this.setBlockAndNotifyAdequately(this.worldObj, aint1[0], aint1[1], aint1[2], block, 3);
                        ++j1;
                    }
                }
            }
    ...
    void func_150530_a(int[] p_150530_1_, int[] p_150530_2_, Block p_150530_3_)
    {
        ...
        if (aint2[b1] != 0)
        {
            ...
            for (int j = aint2[b1] + b4; i != j; i += b4)
            {
                ...
                this.setBlockAndNotifyAdequately(this.worldObj, aint3[0], aint3[1], aint3[2], p_150530_3_, 0);
            }
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.func_150530_a(aint, aint1, Compat.livingwood);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.func_150530_a(aint, aint2, Compat.livingwood);
            }
        }
    }
