...
public class Crafter {
    ...
    public static void lexify(){
        ...
        OreDictionary.registerOre("crafterWood", new ItemStack(RidiculousBlocks.craftBench, 1, OreDictionary.WILDCARD_VALUE));
        OreDictionary.registerOre("craftingTableWood", new ItemStack(RidiculousBlocks.craftBench, 1, OreDictionary.WILDCARD_VALUE));
