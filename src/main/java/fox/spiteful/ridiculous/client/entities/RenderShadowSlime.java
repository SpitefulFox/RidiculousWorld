...
public class RenderShadowSlime extends RenderLiving {

    private static final ResourceLocation slimeTextures = new ResourceLocation("ridiculous", "textures/models/shadowslime.png");
    private ModelBase scaleAmount;

    public RenderShadowSlime(){
