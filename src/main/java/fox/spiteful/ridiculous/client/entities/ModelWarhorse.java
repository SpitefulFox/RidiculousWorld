...
public class ModelWarhorse extends ModelBase{
     ...
     */
    public void render(Entity horse, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
    {
        EntityWarhorse entityhorse = (EntityWarhorse)horse;
    ...
    public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_)
    {
        ...
        EntityWarhorse entityhorse = (EntityWarhorse)p_78086_1_;
        float f8 = 0F;
        float f9 = 0F;
        float f10 = 1.0F - f9;
        float f11 = 0F;
