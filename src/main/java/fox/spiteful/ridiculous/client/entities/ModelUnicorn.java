...
public class ModelUnicorn extends ModelBase {
    ...
    public ModelUnicorn(float scale)
    {
        ...
        this.horn.addBox(-1.5F, -21.0F, 13.0F, 1, 7, 1, scale);
        this.horn.setRotationPoint(1.0F, 4.0F, -10.0F);
        this.mouthTop = new ModelRenderer(this, 24, 18);
        this.mouthTop.addBox(-2.0F, -10.0F, -7.0F, 4, 3, 6, scale);
        ...
        this.mouthBottom.addBox(-2.0F, -7.0F, -6.5F, 4, 2, 5, scale);
        ...
        this.horseRightFaceMetal.addBox(-2.5F, -8.0F, -4.0F, 1, 2, 2, scale);
        ...
        this.horseLeftRein.addBox(2.6F, -6.0F, -6.0F, 0, 3, 16, scale);
        this.horseLeftRein.setRotationPoint(0.0F, 4.0F, -10.0F);
        this.horseRightRein = new ModelRenderer(this, 44, 5);
        this.horseRightRein.addBox(-2.6F, -6.0F, -6.0F, 0, 3, 16, scale);
